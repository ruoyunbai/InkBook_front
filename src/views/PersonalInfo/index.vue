      ...
      <div class="card_body">
        ...
        <div class="body_mid">
          ...
          <div class="user_info">
            ...
            <div class="info_word">
              <div class="info">邮箱：soft@buaa.edu.cn</div>
            </div>
          </div>
        </div>
...
<!--        >&lt;!&ndash;和layout has-sider组合使用&ndash;&gt;-->
<!--        <n-layout has-sider>-->
...
<!--                </n-gi>-->
<!--&lt;!&ndash;                <n-gi span="1">&ndash;&gt;-->
<!--&lt;!&ndash;                  <n-button class="ban" size="large" v-show="isSelf && isadmin">&ndash;&gt;-->
<!--&lt;!&ndash;                    <p class="buttonText3">升级</p>&ndash;&gt;-->
<!--&lt;!&ndash;                  </n-button>&ndash;&gt;-->
<!--&lt;!&ndash;                </n-gi>&ndash;&gt;-->
<!--&lt;!&ndash;                <n-gi style="padding-left: 25px">&ndash;&gt;-->
<!--&lt;!&ndash;                  <n-button class="ban" size="large" v-show="isSelf && isadmin">&ndash;&gt;-->
<!--&lt;!&ndash;                    <p class="buttonText3">降级</p>&ndash;&gt;-->
<!--&lt;!&ndash;                  </n-button>&ndash;&gt;-->
<!--&lt;!&ndash;                </n-gi>&ndash;&gt;-->
<!--              </n-grid>-->
<!--            </n-layout-content>-->
